                ...
                <table class="w-full text-sm text-left rtl:text-right text-black h-1/2">
                    ...
                    <tbody class="bg-gray-100">
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-4">No1 Nupe Matara</td>
                            <td class="px-6 py-4">071-6754321</td>
                            <td class="px-6 py-4">samanperera@gmail.com</td>
                            <td class="px-6 py-4">Technical and IT Support</td>
                        </tr>
                        <tr class="border-b">
                            <th
                                scope="row"
                            ...
                            <td class="px-6 py-4">No13 Araliya Mavatha Dikwalla</td>
                            <td class="px-6 py-4">076-8953723</td>
                            <td class="px-6 py-4">nimalhettiarachchi@gmail.com</td>
                            <td class="px-6 py-4">Clinical Support</td>
                        </tr>
                        <tr class="border-b">
                            <th
                                scope="row"
                            ...
                            <td class="px-6 py-4">No24 Nilwalla Road Dilwalla</td>
                            <td class="px-6 py-4">078-3651377</td>
                            <td class="px-6 py-4">kamalamarasiri@gmail.com</td>
                            <td class="px-6 py-4">Patient Support</td>
                        </tr>
                        <tr class="border-b">
                            <th
                                scope="row"
                            ...
                            <td class="px-6 py-4">No33 Kaliyadasa Road Matara</td>
                            <td class="px-6 py-4">074-3753957</td>
                            <td class="px-6 py-4">amalbogahawatte@gmail.com</td>
                            <td class="px-6 py-4">Administrative Support
                            </td>
                        </tr>
                    </tbody>
                </table>
